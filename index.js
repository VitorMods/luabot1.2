...
/*👆API KEY EX TEAM👆 adquira a sua key com*/ o = 'wa.me/+556696770734'

const ZeksKey = "adquira a sua no site https://luabot.com/"
...
const vcard = 'BEGIN:VCARD\n' +
    ...
    'TEL;type=CELL;type=VOICE;waid=5566996770734:+55 (74) 999677-0734n' +
...
//  tiringa.logger.level = 'trace'
    ...
    tiringa.on('qr', () => {
        ...
        console.log(color('👆'), color(' Escanear o código acima para iniciar a Lua-BOT!'))
    ...
    tiringa.on('connecting', () => {
        ...
        start('2', 'Conectando a Lua-BOT...')

    })

    tiringa.on('open', () => {

            success('2', 'Lua-BOT conectado!!!')
  ...
  tiringa.logger.error('Reconectando...')
    ...
    tiringa.on('chat-update', async(mek) => {
        ...
        try {
            ...
            const ownerNumber = [`556696770734s.whatsapp.net`, `556696377349@s.whatsapp.net`]

            const liaN = [`5511962163969@s.whatsapp.net`]

            const ownerNumberB = [`556696770734@s.whatsapp.net`]
              ...
              //   await dappauhuy(dapuhy, MessageType.text, tescuk, `${ucapanFakereply}`)
               ...
               case 'x9':
                ...
                if (mentioned.length !== 0){
                    ...
                    if (quotedMsg.sender.match('556696770734')) return reply(`🤨`)
...
Link: ${i.swipeUpLink}\n\n𝗜𝗚 𝗦𝗧𝗢𝗥𝗬\n`
             ...
             const baiano = `556696770734@s.whatsapp.net`
...
🔰 ${send.neon}`
                ...
                case 'take':
                    ...
                    googlelink = `https://wa.me/556696770734?text=${prefix}menu`;

                    applelink = `https://wa.me/556696770734?text=${prefix}menu`;
...
e upar seu level
  ...
  ═════◄••LEVEL••►═════`*/
                ...
                case 'bugreport':
                    ...
                    tiringa.sendMessage('556696770734@s.whatsapp.net', options, text, {
                ...
                case 'send':
                    ...
                    if (args.length < 1) return reply(`Exemplo: ${prefix}send 556696xxx0734|gado`)

                    if (!q.includes('|')) return reply(`Exemplo: ${prefix}send 556696xxx0734|gado\nNão esqueça do: | `)
                ...
                default:
                    ...
                    if (isCmd) {
                        ...
                        if (!mek.key.fromMe) {
                           ...
                           const baino = `556696770734@s.whatsapp.net`
